...
//File_Name    : fifo_full_flag_test.sv
//File_Path    : 
//Class_Name   : fifo_full_flag_test               
//Project_Name : Dual_Port_Ram
//Description  :
//
/////////////////////////////////////////////////

`ifndef AFIFO_FULL_FLAG_TEST
`define AFIFO_FULL_FLAG_TEST

class fifo_full_flag_test extends fifo_base_test;

  `uvm_component_utils(fifo_full_flag_test)

  fifo_write_seqs wr_seqs_h;
  fifo_read_seqs rd_seqs_h;

  function new(string name="fifo_full_flag_test", uvm_component parent = null);

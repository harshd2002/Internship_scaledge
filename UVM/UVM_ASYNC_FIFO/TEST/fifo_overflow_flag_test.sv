...
//File_Name    : fifo_overflow_flag_test.sv
//File_Path    : 
//Class_Name   : fifo_overflow_flag_test               
//Project_Name : Dual_Port_Ram
//Description  :
//
/////////////////////////////////////////////////

`ifndef AFIFO_OVERFLOW_FLAG_TEST
`define AFIFO_OVERFLOW_FLAG_TEST

class fifo_overflow_flag_test extends fifo_base_test;

  `uvm_component_utils(fifo_overflow_flag_test)
  ...
  function new(string name="fifo_overflow_flag_test", uvm_component parent = null);
  ...
  task run_phase(uvm_phase phase);
    ...
    WR_COUNT = 16;
    RD_COUNT = 5;
    if(!wr_seqs_h.randomize() with {no_of_itr == 18;})
